      ...
      <ul class="submenu">
        ...
        <li class="submenu__item submenu__item--col1">
          ...
          <ul class="submenu__list">
            ...
            <li class="submenu__list__item"><a class="submenu__itemLink"
                href="/mala/Gama?map=c,specificationFilter_110">Gama</a>
              <div class="submenu__imageWrapper">
        ...
        <li class="submenu__item submenu__item--col2">
          ...
          <div class="submenu__itemWrapper">
            ...
            <ul class="submenu__list">
              <li class="submenu__list__item">
                <a class="submenu__itemLink" href="/mala/sestini?map=c,b">Sestini</a>
              </li>
              <li class="submenu__list__item">
                <a class="submenu__itemLink" href="/mala/stout?map=c,b">Stout</a>
              </li>
              <li class="submenu__list__item">
                <a class="submenu__itemLink" href="/mala/travel-one?map=c,b">Travel One</a>
              </li>
            </ul>
          </div>
          <div class="submenu__itemWrapper">
            ...
            <ul class="submenu__list submenu__list--row">
              <li class="submenu__list__item">
                <a class="submenu__itemLink--withIcon submenu__itemLink--cloth"
                  href="/mala/Tecido%20soft?map=c,specificationFilter_72">Tecido</a>
              </li>
              <li class="submenu__list__item">
                <a class="submenu__itemLink--withIcon submenu__itemLink--hard"
                  href="/mala/Rigida?map=c,specificationFilter_72">Rígido</a>
              </li>
            </ul>
          </div>
            ...
            <ul class="submenu__list submenu__list--row">
              ...
              <li class="submenu__list__item">
                <a class="submenu__itemLink--withIcon submenu__itemLink--retractable"
                  href="/mala/Rodas%20retrateis?map=c,specificationFilter_57">Rodas retráteis</a>
              </li>
            </ul>
          </div>
        </li>
            ...
            <ul class="submenu__list submenu__list--colors submenu__list--row">
              ...
              <li class="submenu__list__item">
                <a class="submenu__itemLink--color submenu__itemLink--golden"
                  href="c/mala/Dourado?map=c,specificationFilter_42" title="Filtrar por: Cor dourada">Dourado</a>
              </li>
              <li class="submenu__list__item">
                <a class="submenu__itemLink--color submenu__itemLink--orange"
                  href="c/mala/Laranja?map=c,specificationFilter_42" title="Filtrar por: Cor laranja">Laranja</a>
              </li>
              <li class="submenu__list__item">
            ...
            <ul class="submenu__list submenu__list--row">
              ...
              <li class="submenu__list__item">
                <a class="submenu__itemLink--withIcon submenu__itemLink--gender submenu__itemLink--yourWay"
                  href="/mala/Do%20seu%20jeito?map=c,specificationFilter_67" title="Filtrar por: Para Todos">Para Todos</a>
              </li>
            </ul>
            <!-- [ FIM ] POR GÊNERO  -->
          </div>
